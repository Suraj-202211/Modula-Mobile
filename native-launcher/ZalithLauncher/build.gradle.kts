...
val zalithPackageName = "com.modulamobile.launcher"
...
configure<com.github.megatronking.stringfog.plugin.StringFogExtension> {
    ...
    fogPackages = arrayOf("com.movtery.zalithlauncher.info")
...
android {
    ...
    // Suppress minimum compile SDK check for preview dependencies
...
tasks.register("generateInfoDistributor") {
    doLast {
        ...
        generateJavaClass(generatedZalithDir, "com.movtery.zalithlauncher.info", "InfoDistributor", constantList)
    }
}
